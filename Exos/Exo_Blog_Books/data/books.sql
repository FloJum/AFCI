...
--
-- Hôte : 127.0.0.1:3306
-- Généré le : mer. 16 mars 2022 à 15:32
...
(29, 'Youhou', 'Moi', '2022-03-10', 0, '19.95');
...
(2, 'fjum@gmail.com', 'lol', 'Wolf', 'null'),
(3, 'fjum@test.lol', 'troll', 'Jean Mich', 'null'),
(5, 'demo@dwwm.fr', 'laon', 'Demo', 'null'),
(6, 'foxhound@live.fr', 'mgs', 'Snake', '[\"membre\"]');
COMMIT;
