                    ...
                    <div class="row">
                        <table class="table col-6 offset-3">
                            <tbody>
                                ...
                                <tr class="text-center">
                                    <td colspan="2"><img class="imgtableau" src="medias/sejours/<?= $sejour['picture'] ?>" alt="Photo <?= $sejour['picture'] ?>"></td>
                                </tr>
                                <tr class="text-center">
                                ...
                                <tr class="text-center">
                                    <?php if (isset($_SESSION['user_type']) && $_SESSION['user_type'] == '["admin"]') :
                                        ...
                                        <?php else : ?>
                                            <td colspan="2">
                                                <form method="post" action="voyage.php?id=<?= $sejour['id'] ?>#ancre">
                                                    <button class="btnnews" type="submit" name="update_option" value="<?= $sejour['id'] ?>">Modifier</button>
                                                </form>
                                                <form method="post">
