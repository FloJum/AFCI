...
--
-- Hôte : 127.0.0.1:3306
-- Généré le : ven. 08 avr. 2022 à 06:34
...
(60, 'COUCOU', 'Bitar Nada', '2022-04-05 11:55:05', 'TEST', '2022-04-05 03:36:44'),
(61, 'Mon rÃ©cit de voyage Ã  Marrakech', 'Saindon France', '2022-04-05 02:51:38', 'Marrakech est une ville Ã  visiter absolument lors dâ€™un voyage au Maroc. Jâ€™en garde dâ€™excellents souvenirs, dâ€™autres un peu plus controversÃ©s, mais je recommande vivement de passer un ou deux jours Ã  Marrakech lorsque lâ€™on a la chance de visiter le Maroc. Jâ€™espÃ¨re que vous pourrez lire Ã  travers ce carnet de voyage de prÃ©cieuses informations pour prÃ©parer votre prochain sÃ©jour au Maroc, et que cet exemple de carnet de voyage pourra vous inspirer.\r\n\r\nNous avons visitÃ©, mon ami et moi, Marrakech il y a quelques mois, lors de notre tour du sud marocain. Nous sommes restÃ©s seulement un jour et demi Ã  Marrakech, le temps de visiter les principaux points dâ€™intÃ©rÃªts (mais nous nâ€™avons pas eu le temps de trainer). Cette ancienne ville impÃ©riale dispose dâ€™un hÃ©ritage historique important, notamment parce que de multiples dynasties se sont succÃ©dÃ©es :  les Almohades, les Almoravides et les Saadiens. Lâ€™architecture des bÃ¢timents et des monuments historiques est trÃ¨s intÃ©ressante.', '2022-04-05 03:31:03');
...
(33, 'Saindon', 'France', 'FranceSaindon@armyspy.com', '$2y$10$uiELnmSgqqI4eRwNv6Spf.EnRxN5FDlqsk6bu.yuSh3isJ95.04JS', '[\"membre\"]');
