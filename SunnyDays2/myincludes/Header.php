...
<nav id="navbarre" class="navbar navbar-expand-sm navbar-light fixed-top">
  <div class="collapse navbar-collapse">
    <ul class="navbar-nav">
      <li class="nav-item">
        <a href="/index2.html" class="nav-link"><img class="logohome" src="/medias/logosunnydays.png" alt="Logo home"></a>
      </li>
      <li class="nav-item">
      ...
      <?php if (isset($_SESSION['user_type'])) : ?>
        <li class="nav-item">
          <form class="navbar-form my-2 my-sm-0" action="Controller.php">
            <button class="btn btndec"><i class="fa fa-sign-out"></i> DECONNEXION</button>
          </form>
        </li>
      <?php else :  ?>
        <li class="nav-item">
